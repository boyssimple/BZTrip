...
@interface VCCause ()<UITableViewDelegate,UITableViewDataSource,UICollectionViewDelegate,UICollectionViewDataSource>
@property (nonatomic, strong) UITableView *table;
@property (nonatomic, strong) UICollectionView *collView;
@property (nonatomic, strong) NSArray *dataSource;
@property (nonatomic, strong) CauseHeaderView *headerView;
@property (nonatomic, strong) CauseOrderView *causeOrderView;
@end

@implementation VCCause
...
- (CauseHeaderView*)headerView{
    if (!_headerView) {
        _headerView = [[CauseHeaderView alloc]initWithFrame:CGRectMake(0, 0, DEVICEWIDTH, 100)];
    }
    return _headerView;
}
